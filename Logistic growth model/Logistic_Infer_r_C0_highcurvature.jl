#=
    ...
    Produces inference and information geometry results for the logistic model, estimating θ = (r,C(0)), in the high curvature region of parameter space
=#
...
plot!(pltsol,(Tspan,Logistic_sol),label = "Underlying model",color = :red, markerstrokewidth = 1.5,legend=:bottomright)
